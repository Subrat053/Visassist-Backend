...
const caseSchema = new mongoose.Schema(
  {
    ...
    checklistId: { type: mongoose.Schema.Types.ObjectId, ref: "ChecklistTemplate" },
    ...
    appointmentIds: { type: [{ type: mongoose.Schema.Types.ObjectId, ref: "Appointment" }], default: [] },
    paymentIds: { type: [{ type: mongoose.Schema.Types.ObjectId, ref: "PaymentTransaction" }], default: [] },
    documentIds: { type: [{ type: mongoose.Schema.Types.ObjectId, ref: "CaseDocument" }], default: [] },
